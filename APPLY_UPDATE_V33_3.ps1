...
$backup = Join-Path (Split-Path $ProjectPath -Parent) ((Split-Path $ProjectPath -Leaf) + '_before_v33_3_' + (Get-Date -Format 'yyyyMMdd_HHmmss_fff'))
...
Write-Host ''
Write-Host 'Corporation v33.3 referral desktop/button hotfix installed successfully.' -ForegroundColor Green

/* Corporation v33.5: home-only referral entry. */
(function(){
  'use strict';
  ...
  window.openReferrals33=async function(){
    if(page!=='businesses'&&page!=='referrals')return;
    page='referrals';renderHeader();
  ...
  window.backFromReferrals33=()=>{page='businesses';updateActiveTab();return render();};
